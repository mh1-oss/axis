    ...
    useEffect(() => {
        if (location.state?.product) {
            setFormData(prev => ({
                ...
                message: `I am interested in ${location.state.product}. Please define the specific requirements...`
            }));
        }
    }, [location.state]);
    ...
    return (
        <div className="bg-background-light dark:bg-background-dark text-gray-800 dark:text-gray-200 transition-colors duration-300">
            ...
            <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
                {/* About Us Section - Styled */}
                <div className="mb-20 text-center bg-gray-50 dark:bg-card-dark rounded-2xl p-8 md:p-12 shadow-sm border border-gray-100 dark:border-gray-800 relative overflow-hidden">
                    <div className="absolute top-0 left-0 w-2 h-full bg-primary" />
                    <span className="text-primary font-bold tracking-wider uppercase text-sm mb-4 block underline decoration-wavy decoration-primary/30 underline-offset-4">{t('aboutUsTitle')}</span>
                    <h2 className="text-3xl md:text-4xl font-display font-bold text-secondary dark:text-white mb-6 relative z-10">
                        {t('heroTitle')}
                    </h2>
                    <p className="max-w-4xl mx-auto text-lg text-gray-600 dark:text-gray-300 leading-relaxed relative z-10">
                        {t('aboutUsDesc')}
                    </p>
                ...
                <div className="text-center mb-16">
                    <h2 className="text-3xl font-display font-bold text-secondary dark:text-white sm:text-4xl">{t('getInTouch')}</h2>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16">
                    ...
                    <div className="bg-surface-light dark:bg-surface-dark p-8 rounded shadow-lg border-t-4 border-primary">
                        <h3 className="text-2xl font-display font-semibold text-secondary dark:text-white mb-6">{t('sendMessage')}</h3>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    <label className="block text-sm font-medium text-gray-700 dark:text-gray-300" htmlFor="name">{t('fullName')}</label>
                                    <div className="mt-1 relative rounded-md shadow-sm">
                                        ...
                                        <input
                                            className="focus:ring-primary focus:border-primary block w-full pl-10 rtl:pr-10 rtl:pl-3 sm:text-sm border-gray-300 dark:border-gray-600 rounded-md dark:bg-background-dark dark:text-white py-3 transition-colors"
                                            id="name"
                                ...
                                <div>
                                    <label className="block text-sm font-medium text-gray-700 dark:text-gray-300" htmlFor="email">{t('emailAddress')}</label>
                                    <div className="mt-1 relative rounded-md shadow-sm">
                                        <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none rtl:right-0 rtl:left-auto rtl:pr-3 rtl:pl-0">
                            ...
                            <div>
                                <label className="block text-sm font-medium text-gray-700 dark:text-gray-300" htmlFor="subject">{t('subject')}</label>
                                <div className="mt-1 relative rounded-md shadow-sm">
                                    <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none rtl:right-0 rtl:left-auto rtl:pr-3 rtl:pl-0">
                                    ...
                                    >
                                        ...
                                        <option>{t('requestQuote')}</option>
                                        <option>{t('projectConsultation')}</option>
                                        <option>{t('careers')}</option>
                                    </select>
                                </div>
                            </div>
                            <div>
                                <label className="block text-sm font-medium text-gray-700 dark:text-gray-300" htmlFor="message">{t('message')}</label>
                                <div className="mt-1">
                                    <textarea
                    ...
                    <div className="flex flex-col gap-8">
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                            <div className="bg-surface-light dark:bg-surface-dark p-6 rounded shadow hover:shadow-md transition-shadow duration-300 flex items-start space-x-4 rtl:space-x-reverse border-l-4 border-primary">
                            ...
                            <div className="bg-surface-light dark:bg-surface-dark p-6 rounded shadow hover:shadow-md transition-shadow duration-300 flex items-start space-x-4 rtl:space-x-reverse border-l-4 border-primary sm:col-span-2">
                                <div className="flex-shrink-0">
